/datum/job/pathfinder
	...
	outfit_type = /decl/hierarchy/outfit/job/torch/crew/exploration/pathfinder/fleet
...
/datum/job/pathfinder/get_description_blurb()
	return "You are the Pathfinder. Your duty is to organize and lead the expeditions to away sites, carrying out the NTEF's Primary Mission. You command Explorers. You make sure that expedition has the supplies and personnel it needs. You can pilot Charon if nobody else provides a pilot. Once on the away mission, your duty is to ensure that anything of scientific interest is brought back to the ship and passed to the relevant research lab."
...
/datum/job/explorer
	...
	outfit_type = /decl/hierarchy/outfit/job/torch/crew/exploration/explorer/fleet
	allowed_branches = list(/datum/mil_branch/fleet)
